// Campaign: "A note from Shadi" — card variant: the same letter, set on a
// cream sheet laid over the dark green. Pairs with founder-note.jsx.
...
function FounderNoteCard({ shopHref = '#' }) {
  const bg = 'forest';
  ...
  return h(M.EmailShell, { bg, textured: true },
    ...
    h(M.Section, { bg, pad: 'md' },
      h(M.Panel, { bg: note_bg, pad: 26, radius: 22 },
        ...
        h(M.Prose, { bg: note_bg, text: 'If you place **your next Milonga order before September 15th**, we’re going to include **FREE samples of our brand-new Mate Latte in your order.**' }),
        ...
        h(M.Prose, { bg: note_bg, size: 16, text: '**It’s a limited run, so grab your next order before September 15th and let us know what you think.**' }),
