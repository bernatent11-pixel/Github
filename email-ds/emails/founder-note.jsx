...
function FounderNote({ shopHref = '#' }) {
  ...
  return h(M.EmailShell, { bg, textured: true },
    ...
    h(M.Section, { bg, pad: 'md' },
      ...
      h('div', { style: {
        fontFamily: M.fontStack, fontSize: 15, fontWeight: 900, color: M.onBg[bg].title, letterSpacing: '0.02em',
      } }, 'Shadi'),
      h('div', { style: {
        fontFamily: M.fontStack, fontSize: 11, fontWeight: 700, letterSpacing: '0.16em',
        textTransform: 'uppercase', color: M.onBg[bg].accent, marginTop: 5,
      } }, 'Founder, Milonga')
    ),
