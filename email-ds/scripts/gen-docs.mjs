...
const D = {
  ...
  Headline: ['Foundations', 'The two-line headline — a statement in Gotham Black, then the turn beneath it in Bold Italic. "CLARITY, / on tap." The contrast is weight and slant rather than colour, so it holds on any background. Keep both lines short; it fails when either wraps.'],
  SpecPills: ['Blocks', 'A cluster of small pills, each stating one fact — the whole formula readable in two seconds. Belongs high in an email, usually under the product shot, before anyone has decided to read.'],
