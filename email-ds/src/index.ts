...
export { Frame, T1PhotoCard, T2BigNumber, T3Minimal, T4Pilot, T5Urgency } from './components/HeroTemplates';
export type { FrameProps, Cta, T1Props, T2Props, T3Props, T4Props, T5Props } from './components/HeroTemplates';
