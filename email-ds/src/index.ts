...
export { Frame, T1PhotoCard, T2BigNumber, T3Minimal, T4Pilot, T5Urgency, T6FullImage } from './components/HeroTemplates';
export type { FrameProps, Cta, T1Props, T2Props, T3Props, T4Props, T5Props, T6Props } from './components/HeroTemplates';
