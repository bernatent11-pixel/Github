...
export { Frame, T1PhotoCard, T2BigNumber, T3Minimal, T4Pilot, T5Urgency, T6FullImage, T7Statement, T8Callouts } from './components/HeroTemplates';
export type { FrameProps, Cta, T1Props, T2Props, T3Props, T4Props, T5Props, T6Props, T7Props, T8Props, CalloutRow } from './components/HeroTemplates';
